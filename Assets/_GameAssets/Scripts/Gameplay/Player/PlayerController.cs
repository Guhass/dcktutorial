...
public class PlayerController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        _startingMovementSpeed = _movemementSpeed;
    ...
    private void SetPlayerMovement()
    {
        ...
        _playerRigidbody.AddForce(_movementDirection.normalized * _movemementSpeed * forceMultiplier, ForceMode.Force);
    }
    ...
    {
        _movemementSpeed += speed;
        Invoke(nameof(ResetMovementSpeed), duration);
    }

    private void ResetMovementSpeed()
    {
        _movemementSpeed = _startingMovementSpeed;
    }
