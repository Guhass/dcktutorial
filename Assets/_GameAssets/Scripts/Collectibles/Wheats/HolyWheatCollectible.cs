...
public class HolyWheatCollectible : MonoBehaviour, ICollectible
{
    ...
    public void Collect()
    {
        ...
        _playerStateUI.PlayBoosterUIAnimations(_playerBoosterTransform, _playerBoosterImage, _playerStateUI.GetHolyBoosterWheatImage, _wheatDesingSO.ActiveSprite, _wheatDesingSO.PassiveSprite,
